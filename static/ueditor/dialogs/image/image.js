...
//                }
    ...
    var Upload = {
        ...
        config: function (sel) {
            ...
            url=url + (url.indexOf("?") == -1 ? "?" : "&") + "editorid="+me.editor.id;//��ʼform�ύ��ַ;
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            "<cf><tr><td><input class=\"edui-image-searchTxt\" type=\"text\"></td>" +
            "<td><div class=\"edui-image-searchAdd\"><%=lang_btn_add%></div></td></tr></cf>" +
            "</div>" +
